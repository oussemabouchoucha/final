const invitation_subject =(username)=>{ return `${username} has invited you to join them in LeadsBuffet`;}

const invitation_html = (link: string, senderusername: string, senderemail: string) => {
  return `
  <!doctype html>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;">
                                                ${senderusername} (${senderemail}) has invited you to join LeadsBuffet. <br/> <br/><br/>
                                                
                                                Get started by joining them.
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:20px;text-align:center;color:#7F8FA4;">
                                                If at any point you need help with using LeadsBuffet, email us at <br/>
                                                <a href="support@leadsbuffet.com">support@leadsbuffet.com</a>
                                            </div>
...
export { invitation_subject, invitation_html };
